...
fun SettingsScreen(navController: NavHostController) {
    ...
    Column(
        ...
        SectionTitle("账号")
        Row(
            Modifier.fillMaxWidth().clickable { navController.navigate(com.zyakusen.tsukiyo.ui.navigation.Routes.LOGIN) }.padding(16.dp),
        ...
        LazyRow(
            ...
            items(com.zyakusen.tsukiyo.util.tagLanguageOptions) { (lang, label) ->
        ...
        Row(
            ...
            TextButton(onClick = {
                scope.launch {
                    ...
                    val text = if (freed > 0) "已清理 ${com.zyakusen.tsukiyo.util.formatSize(freed)}" else "缓存已清理"
...
@Composable
private fun ProxyDialog(container: com.zyakusen.tsukiyo.data.AppContainer, onDismiss: () -> Unit) {
    val settings by container.settingsStore.state.collectAsState()

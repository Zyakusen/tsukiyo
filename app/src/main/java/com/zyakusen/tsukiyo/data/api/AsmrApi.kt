package com.zyakusen.tsukiyo.data.api

import com.zyakusen.tsukiyo.data.model.AuthResponse
import com.zyakusen.tsukiyo.data.model.CreatePlaylistRequest
import com.zyakusen.tsukiyo.data.model.LoginRequest
import com.zyakusen.tsukiyo.data.model.Playlist
import com.zyakusen.tsukiyo.data.model.PlaylistWorksRequest
import com.zyakusen.tsukiyo.data.model.PlaylistsResponse
import com.zyakusen.tsukiyo.data.model.ReviewRequest
...
import com.zyakusen.tsukiyo.data.model.VoteRequest
...
interface AsmrApi {
    ...
    @GET("api/tracks/{id}")
    suspend fun getTracks(@Path("id") id: Long): List<com.zyakusen.tsukiyo.data.model.Track>
    ...
    suspend fun popular(@Body body: com.zyakusen.tsukiyo.data.model.RecommenderRequest): WorksResponse

    @POST("api/recommender/recommend-for-user")
    suspend fun recommendForUser(@Body body: com.zyakusen.tsukiyo.data.model.RecommenderRequest): WorksResponse

    @POST("api/recommender/item-neighbors")
    suspend fun itemNeighbors(@Body body: com.zyakusen.tsukiyo.data.model.ItemNeighborsRequest): WorksResponse
    ...
    suspend fun editPlaylistMetadata(@Body body: com.zyakusen.tsukiyo.data.model.EditPlaylistRequest): Any
}
